...
const styles = StyleSheet.create({
  ...
  header: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: 16, paddingVertical: 12, borderBottomWidth: StyleSheet.hairlineWidth, borderBottomColor: 'rgba(128,128,128,0.2)' },
  backButton: { padding: 6 },
  headerTitle: { fontSize: 17, fontFamily: 'Nunito-Bold', textAlign: 'left', marginLeft: 12 },

  scrollContent: { paddingBottom: 30 },

  mediaGridContainer: { paddingVertical: 12 },
  mediaGrid: { flexDirection: 'row', flexWrap: 'wrap', paddingHorizontal: 2 },
  mediaItem: { width: ITEM_SIZE, height: ITEM_SIZE, margin: GRID_GAP / 2, borderRadius: 8, overflow: 'hidden', position: 'relative', backgroundColor: '#000' },
  mediaImage: { width: '100%', height: '100%' },

  videoBadge: { position: 'absolute', top: 6, left: 6, width: 22, height: 22, borderRadius: 10, backgroundColor: 'rgba(0,0,0,0.6)', alignItems: 'center', justifyContent: 'center' },
  orderBadge: { position: 'absolute', top: 6, right: 6, minWidth: 22, height: 22, paddingHorizontal: 4, borderRadius: 10, backgroundColor: 'rgba(0,0,0,0.6)', alignItems: 'center', justifyContent: 'center' },
  orderBadgeText: { color: '#FFF', fontSize: 11, fontFamily: 'Nunito-Bold' },

  removeButton: { position: 'absolute', top: 4, right: 4, width: 24, height: 24, borderRadius: 12, borderWidth: 1, borderColor: 'rgba(255,255,255,0.2)', backgroundColor: 'rgba(0,0,0,0.75)', alignItems: 'center', justifyContent: 'center' },

  addMediaButton: { width: ITEM_SIZE, height: ITEM_SIZE, margin: GRID_GAP / 2, borderRadius: 8, borderWidth: 1.5, borderStyle: 'dashed', alignItems: 'center', justifyContent: 'center', gap: 4 },
  addMediaText: { fontSize: 12, fontFamily: 'Nunito-Bold' },

  mediaInfoRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: 12, paddingTop: 10 },
  mediaInfoLeft: { flexDirection: 'row', alignItems: 'center', gap: 6 },
  mediaInfoText: { fontSize: 13, fontFamily: 'Nunito-Bold' },
  mediaInfoHint: { fontSize: 11, fontFamily: 'Nunito-Regular' },

  formContainer: { paddingHorizontal: 16, paddingTop: 8 },
  label: { fontSize: 14, fontFamily: 'Nunito-Bold', marginBottom: 6 },
  input: { borderRadius: 10, borderWidth: 1, paddingHorizontal: 14, paddingVertical: 12, marginBottom: 16, fontSize: 15, fontFamily: 'Nunito-Regular' },
  textArea: { height: 100, textAlignVertical: 'top' },
  rowInputs: { flexDirection: 'row', gap: 10 },
  halfInput: { flex: 1 },

  publishButton: { borderRadius: 12, paddingVertical: 15, marginTop: 8, marginBottom: 20, alignItems: 'center', elevation: 3, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.15, shadowRadius: 4 },
  publishButtonContent: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  publishButtonText: { color: '#FFF', fontSize: 16, fontFamily: 'Nunito-Bold' },

  toast: { position: 'absolute', top: 70, left: 20, right: 20, flexDirection: 'row', alignItems: 'center', gap: 10, paddingHorizontal: 16, paddingVertical: 14, borderRadius: 10, zIndex: 999, elevation: 5, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.25, shadowRadius: 4 },
  toastText: { flex: 1, color: '#FFF', fontSize: 14, fontFamily: 'Nunito-Bold' },
});