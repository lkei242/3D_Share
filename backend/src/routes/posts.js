...
router.get('/feed', async (req, res) => {
  try {
    ...
    if (postsDb.length === 0 && page === 1) {
      return res.json({
        posts: [
          { id: 'm1', title: 'Soporte auriculares (Mock)', image: 'https://picsum.photos/seed/a1/400/300', price: '5000$', views: '1.2k', totalImages: 1, description: 'Soporte premium para auriculares impreso en PLA color negro.', author: 'mock1' },
          { id: 'm2', title: 'Figura de dragón (Mock)', image: 'https://picsum.photos/seed/a2/400/300', price: null, views: '890', totalImages: 3, description: 'Increíble figura coleccionable articulada impresa en resina.', author: 'mock2' },
          { id: 'm3', title: 'Cancha de Boca (Mock)', image: 'https://picsum.photos/seed/a3/400/300', price: null, views: '45k', totalImages: 1, description: 'Maqueta detallada del estadio de Boca Juniors.', author: 'mock3' },
        ],
        hasMore: false
      });
    }
